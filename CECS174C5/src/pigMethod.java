...
public class pigMethod {
	...
	*/
public static int diceRoll (String playerX, int total, int Gameover, String playerY) {
	Scanner enter = new Scanner (System.in);
	int roll;
	int round = 0;
	String input = "";
	do {
	    ...
	    System.out.println("Player " + playerX + " rolled: " + roll);
           if(roll == 1){
               round = 0;
               total = 0;
               System.out.print("Turn over \n");
           ...
           {         
              ...
              System.out.println("===========================");
              System.out.print("Player " + playerX + ": " + (round + total) + " points \n");
              System.out.println("===========================");
...
public static void main (String[] args){
	...
	int Gameover = 20;
		while (1 < 2) {
			...
			System.out.println("");
			player1 = diceRoll("1", player1, Gameover, "2");
			if (player1 >= Gameover)
			{
			...
			System.out.println("");
			player2 = diceRoll("2", player2, Gameover, "1");
			if (player2 >= Gameover)
			{
